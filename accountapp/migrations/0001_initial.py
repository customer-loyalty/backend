# Generated by Django 4.2 on 2023-09-09 13:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase_amount', models.ForeignKey(default='Мужской пол', on_delete=django.db.models.deletion.CASCADE, to='accountapp.purchaseamount', verbose_name='Покупка')),
            ],
            options={
                'verbose_name': 'Клиент',
