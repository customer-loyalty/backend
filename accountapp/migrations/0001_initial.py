# Generated by Django 4.2 on 2023-09-26 06:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(db_index=True, max_length=30, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator(), django.core.validators.RegexValidator('^[a-zA-Zа-яА-ЯёЁ\\s-]+$', 'Может содержать только буквы русского и английского алфавита, пробел и тире.'), django.core.validators.MinLengthValidator(2)], verbose_name='Уникальное имя')),
                ...
                ('first_name', models.CharField(blank=True, max_length=30, validators=[django.core.validators.RegexValidator('^[а-яА-ЯёЁ\\s-]+$', 'Может содержать только буквы русского алфавита, пробел и тире.'), django.core.validators.MinLengthValidator(2)], verbose_name='first name')),
                ('last_name', models.CharField(blank=True, max_length=30, validators=[django.core.validators.RegexValidator('^[а-яА-ЯёЁ\\s-]+$', 'Может содержать только буквы русского алфавита, пробел и тире.'), django.core.validators.MinLengthValidator(2)], verbose_name='last name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('card', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accountapp.card', verbose_name='Карта клиента')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите свое имя', max_length=30, validators=[django.core.validators.RegexValidator('^[а-яА-ЯёЁ\\s-]+$', 'Может содержать только буквы русского алфавита, пробел и тире.'), django.core.validators.MinLengthValidator(2)], verbose_name='Имя')),
                ('surname', models.CharField(help_text='Введите свою фамилию', max_length=30, validators=[django.core.validators.RegexValidator('^[а-яА-ЯёЁ\\s-]+$', 'Может содержать только буквы русского алфавита, пробел и тире.'), django.core.validators.MinLengthValidator(2)], verbose_name='Фамилия')),
                ...
                ('card', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accountapp.card', verbose_name='Карта')),
        ...
        migrations.AddField(
            model_name='card',
            name='cardType',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='accountapp.typecard', verbose_name='Тип карты'),
        ),
    ]
