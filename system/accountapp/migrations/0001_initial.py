    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cardId', models.IntegerField(max_length=16, verbose_name='Баланс карты')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('middleName', models.CharField(help_text='Введите свою фамилию', max_length=150, verbose_name='Фамилия')),
                ('surname', models.CharField(help_text='Введите свое отчество', max_length=150, verbose_name='Отчество')),
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(blank=True, help_text='Введите Ваш телефонный номер', max_length=128, null=True, region=None, verbose_name='Телефонный номер')),
